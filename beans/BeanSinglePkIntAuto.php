...
/**
 * Class BeanSinglePkIntAuto
 * Bean class for object oriented management of the MySQL table single_pk_int_auto
 *
 * Comment of the managed table single_pk_int_auto: Not specified.
 *
 * Responsibility:
 *
 ...
 *
 * @extends MySqlRecord
 * @filesource BeanSinglePkIntAuto.php
...
class BeanSinglePkIntAuto extends MySqlRecord
{
    /**
    ...
    /**
     * Class attribute for mapping the primary key id_int_auto of table single_pk_int_auto
     *
     * Comment for field id_int_auto: Not specified<br>
     * @var int $idIntAuto
     */
    private $idIntAuto;
    ...
    /**
     * Class attribute for storing the SQL DDL of table single_pk_int_auto
     * @var string base64 encoded string for DDL
     */
    private $ddl = "";

    /**
     * setIdIntAuto Sets the class attribute idIntAuto with a given value
     *
     * The attribute idIntAuto maps the field id_int_auto defined as int(11).<br>
     * Comment for field id_int_auto: Not specified.<br>
     * @param int $idIntAuto
     * @category Modifier
     */
    public function setIdIntAuto($idIntAuto)
    {
        $this->idIntAuto = (int)$idIntAuto;
    }
    ...
    /**
     * getIdIntAuto gets the class attribute idIntAuto value
     *
     * The attribute idIntAuto maps the field id_int_auto defined as int(11).<br>
     * Comment for field id_int_auto: Not specified.
     * @return int $idIntAuto
     * @category Accessor of $idIntAuto
     */
    public function getIdIntAuto()
    {
        return $this->idIntAuto;
    }
    ...
    /**
     * Gets DDL SQL code of the table single_pk_int_auto
     * @return string
     * @category Accessor
     */
    ...
    */
    ...
    {
        return "single_pk_int_auto";
    }

    /**
     * The BeanSinglePkIntAuto constructor
     *
     * It creates and initializes an object in two way:
     *  - with null (not fetched) data if none $idIntAuto is given.
     *  - with a fetched data row from the table single_pk_int_auto having id_int_auto=$idIntAuto
     * @param int $idIntAuto. If omitted an empty (not fetched) instance is created.
     * @return BeanSinglePkIntAuto Object
     */
    public function __construct($idIntAuto = null)
    {
        parent::__construct();
        if (!empty($idIntAuto)) {
            $this->select($idIntAuto);
        }
    }
    ...
    /**
     * Fetchs a table row of single_pk_int_auto into the object.
     *
     * Fetched table fields values are assigned to class attributes and they can be managed by using
     * the accessors/modifiers methods of the class.
     * @param int $idIntAuto the primary key id_int_auto value of table single_pk_int_auto which identifies the row to select.
     * @return int affected selected row
     * @category DML
     */
    public function select($idIntAuto)
    {
        $sql =  "SELECT * FROM single_pk_int_auto WHERE id_int_auto={$this->parseValue($idIntAuto,'int')}";
        ...
        if ($result){
            ...
            @$this->idIntAuto = (integer)$rowObject->id_int_auto;
    ...
    /**
     * Deletes a specific row from the table single_pk_int_auto
     * @param int $idIntAuto the primary key id_int_auto value of table single_pk_int_auto which identifies the row to delete.
     * @return int affected deleted row
     * @category DML
     */
    public function delete($idIntAuto)
    {
        $sql = "DELETE FROM single_pk_int_auto WHERE id_int_auto={$this->parseValue($idIntAuto,'int')}";
        $this->resetLastSqlError();
        $result = $this->query($sql);
        $this->lastSql = $sql;
        if (!$result) {
    ...
    /**
     * Insert the current object into a new table row of single_pk_int_auto
     *
    ...
    public function insert()
    {
        ...
        $sql = <<< SQL
            INSERT INTO single_pk_int_auto
            (field_string,field_date,field_date_time,field_decimal,field_int,field_text)
            VALUES(
...
SQL;
    ...
    /**
     * Updates a specific row from the table single_pk_int_auto with the values of the current object.
     *
     * All class attribute values defined for mapping all table fields are automatically used during updating of selected row.<br>
     * Null values are used for all attributes not previously setted.
     * @param int $idIntAuto the primary key id_int_auto value of table single_pk_int_auto which identifies the row to update.
     * @return mixed MySQL update result
     * @category DML
     */
    public function update($idIntAuto)
    {
        // $constants = get_defined_constants();
        if ($this->allowUpdate) {
            $sql = <<< SQL
            ...
            WHERE
                id_int_auto={$this->parseValue($idIntAuto,'int')}
SQL;
            $this->resetLastSqlError();
            $result = $this->query($sql);
            if (!$result) {
    ...
    /**
     * Facility for updating a row of single_pk_int_auto previously loaded.
     *
    ...
    {
        if ($this->idIntAuto != "") {
            return $this->update($this->idIntAuto);
        } else {
            return false;
        }
    }
