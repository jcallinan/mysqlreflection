...
/**
 * Class BeanDeptManager
 * Bean class for object oriented management of the MySQL table dept_manager
 *
 * Comment of the managed table dept_manager: Not specified.
 *
 * Responsibility:
 *
 ...
 *
 * @extends MySqlRecord
 * @filesource BeanDeptManager.php
...
class BeanDeptManager extends MySqlRecord
{
    /**
    ...
    /**
     * Class attribute for storing the SQL DDL of table dept_manager
     * @var string base64 encoded string for DDL
     */
    private $ddl = "";
    ...
    /**
     * Gets DDL SQL code of the table dept_manager
     * @return string
     * @category Accessor
     */
    ...
    */
    ...
    /**
    * The BeanDeptManager constructor
    *
    ...
    */
    ...
    /**
    * Fetchs a table row of dept_manager into the object.
    *
    ...
    */
    ...
    {
        $sql =  "SELECT * FROM dept_manager WHERE emp_no={$this->parseValue($empNo,'int')} AND dept_no={$this->parseValue($deptNo,'string')}";
    ...
    /**
    * Deletes a specific row from the table dept_manager
	* @param int $empNo
	* @param string $deptNo
    ...
    */
    ...
    {
        $sql = "DELETE FROM dept_manager WHERE emp_no={$this->parseValue($empNo,'int')} AND dept_no={$this->parseValue($deptNo,'string')}";
        $this->resetLastSqlError();
        $result = $this->query($sql);
        $this->lastSql = $sql;
        if (!$result) {
    ...
    /**
    * Insert the current object into a new table row of dept_manager
    *
...
SQL;
    ...
    /**
    * Updates a specific row from the table dept_manager with the values of the current object.
    *
...
SQL;
    ...
    /**
    * Facility for updating a row of dept_manager previously loaded.
    *
